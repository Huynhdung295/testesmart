            ...
            <div className="wpb_wrapper">
                  ...
                  <div className="category item col-md-3 ">
                    ...
                    >
                      <a href="/#" className="#categoryid_51">
                        <span className="cat-name">phones</span>
                      </a>
                      <br />
                  ...
                  >
                    <div className="woocommerce columns-2 ">
                      <ul className="products columns-2">
                                ...
                                <div className="overlay-components">
                                  ...
                                  <div className="component wishlist hide-on-mobile">
                                    <div className="yith-wcwl-add-to-wishlist add-to-wishlist-4471">
                                      ...
                                      >
                                        <a
                                          href="/shop/products-by-categories/?add_to_wishlist=4471"
                                ...
                                <div className="details-price-container details-item">
                                  <div className="woocommerce-product-details__short-description">
                                    <p>
                                      ...
                                      picked up. Particularly popular in both
                                      the United Kingdom and the breed
                                    </p>
                                  </div>
                                  Auction Ended
                                  <div className="details-review-container details-item" />
                                ...
                                <div className="overlay-components">
                                  ...
                                  <div className="component wishlist hide-on-mobile">
                                    <div className="yith-wcwl-add-to-wishlist add-to-wishlist-4473">
                                      ...
                                      >
                                        <a
                                          href="/shop/products-by-categories/?add_to_wishlist=4473"
                                ...
                                <div className="details-price-container details-item">
                                  <div className="woocommerce-product-details__short-description">
                                    <p>
                                      ...
                                      At the end of the day. Override the
                                      digital divide with
                                    </p>
                                  </div>
                                  Auction Ended
                        ...
                        <li className=" last post-4469 product type-product status-publish has-post-thumbnail product_cat-electronics product_cat-laptops product_cat-phones product_tag-black-friday product_tag-sales first outofstock featured sold-individually shipping-taxable product-type-auction">
                          <div className="products-wrapper">
                            <div className="thumbnail-and-details">
                              <div className="overlay-container">
                                <div className="thumbnail-overlay" />
                                <div className="overlay-components">
                                  ...
                                  <div className="component wishlist hide-on-mobile">
                                    <div className="yith-wcwl-add-to-wishlist add-to-wishlist-4469">
                                      ...
                                      >
                                        <a
                                          href="/shop/products-by-categories/?add_to_wishlist=4469"
              ...
              <div className="woocommerce_categories2">
                <div className="products_category">
                  <div className="category item col-md-3 ">
                    <div
                      style={{ background: "radial-gradient(#ff5f4a,#dd3e29)" }}
                      className="category-wrapper"
                    >
                      <a href="/#" className="#categoryid_47">
                        <span className="cat-name">electronics</span>
                      </a>
                      <br />
                      <span className="cat-count">
                        <strong>9</strong> Products
                      </span>
                      <br />
                      <div className="category-button ">
                        <a
                          href="https://ibid.modeltheme.com/product-category/electronics/"
                          className="button"
                          title="View more"
                        >
                          <span>View all products</span>
                  ...
                  <div
                    id="categoryid_47"
                    className=" col-md-9 products_by_categories Electronics"
                  >
                    <div className="woocommerce columns-2 ">
                      <ul className="products columns-2">
                        <li className=" first post-13545 product type-product status-publish has-post-thumbnail product_cat-electronics product_cat-televisions product_tag-black-friday product_tag-sales last instock sold-individually shipping-taxable product-type-auction">
                          <div className="products-wrapper">
                            <div className="thumbnail-and-details">
                              <div className="overlay-container">
                                <div className="thumbnail-overlay" />
                                <div className="overlay-components">
                                  <div className="component add-to-cart">
                                    <a
                                      href="https://ibid.modeltheme.com/product/auto-bidding/"
                                      data-quantity={1}
                                  ...
                                  <div className="component wishlist hide-on-mobile">
                                    <div className="yith-wcwl-add-to-wishlist add-to-wishlist-13545">
                                      ...
                                      >
                                        <a
                                          href="/shop/products-by-categories/?add_to_wishlist=13545"
                              ...
                              <a
                                className="woo_catalog_media_images"
                                title="Auto Bidding (Proxy)"
                                href="https://ibid.modeltheme.com/product/auto-bidding/"
                              >
                                <img
                                  width={300}
                                  height={300}
                                  src="https://ibid.modeltheme.com/wp-content/uploads/2018/10/electronic-cat1-300x300.jpg"
                                  className="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                  alt=""
                                  loading="lazy"
                                  srcSet="https://ibid.modeltheme.com/wp-content/uploads/2018/10/electronic-cat1-300x300.jpg 300w, https://ibid.modeltheme.com/wp-content/uploads/2018/10/electronic-cat1-200x200.jpg 200w, https://ibid.modeltheme.com/wp-content/uploads/2018/10/electronic-cat1-600x600.jpg 600w, https://ibid.modeltheme.com/wp-content/uploads/2018/10/electronic-cat1-150x150.jpg 150w, https://ibid.modeltheme.com/wp-content/uploads/2018/10/electronic-cat1-768x768.jpg 768w, https://ibid.modeltheme.com/wp-content/uploads/2018/10/electronic-cat1-1024x1024.jpg 1024w, https://ibid.modeltheme.com/wp-content/uploads/2018/10/electronic-cat1-350x350.jpg 350w, https://ibid.modeltheme.com/wp-content/uploads/2018/10/electronic-cat1-110x110.jpg 110w, https://ibid.modeltheme.com/wp-content/uploads/2018/10/electronic-cat1-400x400.jpg 400w, https://ibid.modeltheme.com/wp-content/uploads/2018/10/electronic-cat1-70x70.jpg 70w, https://ibid.modeltheme.com/wp-content/uploads/2018/10/electronic-cat1.jpg 1080w"
                                  sizes="(max-width: 300px) 100vw, 300px"
                                />
                                <img
                                  className="woo_secondary_media_image"
                                  src="https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat3-400x400.jpg"
                                  alt="Auto Bidding (Proxy)"
                                />
                                <div
                                  className="countdownv2_holder "
                                  data-insert-date-start=""
                                  data-insert-date="2022-12-22 00:00:00"
                                  data-unique-id="countdown_636ba5f38508d"
                            ...
                            >
                              <h3 className="archive-product-title">
                                <a href="https://ibid.modeltheme.com/product/auto-bidding/">
                                  Auto Bidding (Proxy){" "}
                                </a>
                              </h3>
                              <div className="details-container">
                        ...
                        <li className=" last post-4452 product type-product status-publish has-post-thumbnail product_cat-electronics product_cat-televisions product_tag-black-friday product_tag-sales first instock sold-individually shipping-taxable product-type-auction">
                          <div className="products-wrapper">
                            <div className="thumbnail-and-details">
                              <div className="overlay-container">
                                <div className="thumbnail-overlay" />
                                <div className="overlay-components">
                                  ...
                                  <div className="component wishlist hide-on-mobile">
                                    <div className="yith-wcwl-add-to-wishlist add-to-wishlist-4452">
                                      ...
                                      >
                                        <a
                                          href="/shop/products-by-categories/?add_to_wishlist=4452"
                              ...
                              >
                                <img
                                  width={300}
                                  height={300}
                                  src="https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat2-300x300.jpg"
                                  className="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                  alt=""
                                  loading="lazy"
                                  srcSet="https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat2-300x300.jpg 300w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat2-200x200.jpg 200w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat2-600x600.jpg 600w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat2-150x150.jpg 150w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat2-768x768.jpg 768w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat2-1024x1024.jpg 1024w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat2-350x350.jpg 350w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat2-110x110.jpg 110w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat2-400x400.jpg 400w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat2-70x70.jpg 70w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat2.jpg 1080w"
                                  sizes="(max-width: 300px) 100vw, 300px"
                                />
                                <img
                                  className="woo_secondary_media_image"
                                  src="https://ibid.modeltheme.com/wp-content/uploads/2018/09/laptop-cat1-400x400.jpg"
                                ...
                                <div
                                  ...
                                  data-unique-id="countdown_636ba5f387571"
                                  data-countdown-direction="false"
                                  data-date-format-redux="DHMS"
                                  data-gmt-offset={0}
                                >
                            ...
                            >
                              ...
                              <div className="details-container">
                                <div className="details-price-container details-item">
                                  <div className="woocommerce-product-details__short-description">
                                    <p>
                                      Product a reality sandwich before you walk
                                      back in that boardroom fire up your
                                      browser, so come up with something
                                      buzzworthy, for it’s about managing
                        ...
                        <li className=" first post-4471 product type-product status-publish has-post-thumbnail product_cat-electronics product_cat-phones product_tag-black-friday product_tag-sales last instock sold-individually shipping-taxable product-type-auction">
                          <div className="products-wrapper">
                            <div className="thumbnail-and-details">
                              <div className="overlay-container">
                                <div className="thumbnail-overlay" />
                        ...
                        <li className=" last post-4331 product type-product status-publish has-post-thumbnail product_cat-electronics product_cat-televisions product_tag-accessories product_tag-gaming first instock featured sold-individually shipping-taxable product-type-auction">
                          <div className="products-wrapper">
                            <div className="thumbnail-and-details">
                              <div className="overlay-container">
                                <div className="thumbnail-overlay" />
                                <div className="overlay-components">
                                  ...
                                  <div className="component wishlist hide-on-mobile">
                                    <div className="yith-wcwl-add-to-wishlist add-to-wishlist-4331">
                                      ...
                                      >
                                        <a
                                          href="/shop/products-by-categories/?add_to_wishlist=4331"
                              ...
                              >
                                ...
                                <div
                                  ...
                                  data-unique-id="countdown_636ba5f38a568"
                                  data-countdown-direction="false"
                                  data-date-format-redux="DHMS"
                                  data-gmt-offset={0}
                                >
                            ...
                            >
                              ...
                              <div className="details-container">
                                <div className="details-price-container details-item">
                                  <div className="woocommerce-product-details__short-description">
                                    <p>
                                      Samsung Galaxy S9 smartphone was launched
                                      in March 2018. The phone comes with a
                                      5.80-inch touchscreen display with a
                                      resolution of 1440 pixels by 2960 pixels
                                      at a PPI of 568 pixels per inch. Samsung
                                      Galaxy S9 price in India starts from Rs.
                                      51,990.
                                    </p>
                                    <p>
                                      The Samsung Galaxy S9 runs Android 8.0 and
                                      is powered by a 3000mAh non removable
                                      battery. It measures 147.70 x 68.70 x 8.50
                                      (height x width x thickness) and weighs
                                      163.00 grams.
                                    </p>
                                  </div>
                                  <span className="price">
              ...
              <div className="woocommerce_categories2">
                <div className="products_category">
                  <div className="category item col-md-3 ">
                    <div
                      style={{ background: "radial-gradient(#fce406,#f9be00)" }}
                      className="category-wrapper"
                    >
                      <a href="/#" className="#categoryid_49">
                        <span className="cat-name">laptops</span>
                      </a>
                      <br />
                      <span className="cat-count">
                      ...
                      <div className="category-button ">
                        <a
                          href="https://ibid.modeltheme.com/product-category/laptops/"
                          className="button"
                          title="View more"
                        >
                          <span>View all products</span>
                  ...
                  <div
                    id="categoryid_49"
                    className=" col-md-9 products_by_categories Laptops IT Products"
                  >
                    <div className="woocommerce columns-2 ">
                      <ul className="products columns-2">
                        <li className=" first post-4469 product type-product status-publish has-post-thumbnail product_cat-electronics product_cat-laptops product_cat-phones product_tag-black-friday product_tag-sales last outofstock featured sold-individually shipping-taxable product-type-auction">
                          <div className="products-wrapper">
                            <div className="thumbnail-and-details">
                              <div className="overlay-container">
                                <div className="thumbnail-overlay" />
                                ...
                                <div className="overlay-components">
                                  ...
                                  <div className="component wishlist hide-on-mobile">
                                    <div className="yith-wcwl-add-to-wishlist add-to-wishlist-4461">
                                      ...
                                      >
                                        <a
                                          href="/shop/products-by-categories/?add_to_wishlist=4461"
                            ...
                            >
                              ...
                              <div className="details-container">
                                <div className="details-price-container details-item">
                                  <div className="woocommerce-product-details__short-description">
                                    <p>
                                      Product galati a reality sandwich before
                                      you walk back in that boardroom fire up
                                      your browser, so come up with something
                                      buzzworthy, for it’s about managing
                                      expectations yet baseline into the weeds.
                                    </p>
                                  </div>
                        ...
                        <li className=" first post-4458 product type-product status-publish has-post-thumbnail product_cat-laptops product_cat-selfie-stickers product_tag-black-friday product_tag-sales last instock featured sold-individually shipping-taxable product-type-auction">
                          <div className="products-wrapper">
                            <div className="thumbnail-and-details">
                              <div className="overlay-container">
                                <div className="thumbnail-overlay" />
                                <div className="overlay-components">
                                  ...
                                  <div className="component wishlist hide-on-mobile">
                                    <div className="yith-wcwl-add-to-wishlist add-to-wishlist-4458">
                                      ...
                                      >
                                        <a
                                          href="/shop/products-by-categories/?add_to_wishlist=4458"
                        ...
                        <li className=" last post-4462 product type-product status-publish has-post-thumbnail product_cat-accessories product_cat-laptops product_tag-accessories product_tag-black-friday product_tag-gaming first instock sold-individually shipping-taxable purchasable product-type-auction">
                          <div className="products-wrapper">
                            <div className="thumbnail-and-details">
                              <div className="overlay-container">
                                <div className="thumbnail-overlay" />
                                <div className="overlay-components">
                                  <div className="component add-to-cart">
                                    <a
                                      href="https://ibid.modeltheme.com/product/apple-magic-mouse-2/"
                                      data-quantity={1}
                                      data-tooltip="Bid Now"
                                      className="button product_type_auction add_to_cart_button"
                                      data-product_id={4462}
                                      data-product_sku="BA003"
                                      aria-label="Read more about “Magic Mouse v2”"
                                      rel="nofollow"
                                    >
                                      <i className="fa fa-gavel" />
                                    </a>
                                  ...
                                  <div className="component wishlist hide-on-mobile">
                                    <div className="yith-wcwl-add-to-wishlist add-to-wishlist-4462">
                                      <div
                                        className="yith-wcwl-add-button show"
                                        style={{ display: "block" }}
                                      >
                                        <a
                                          href="/shop/products-by-categories/?add_to_wishlist=4462"
                              ...
                              <a
                                className="woo_catalog_media_images"
                                title="Magic Mouse v2"
                                href="https://ibid.modeltheme.com/product/apple-magic-mouse-2/"
                              >
                                <img
                                  width={300}
                                  height={300}
                                  src="https://ibid.modeltheme.com/wp-content/uploads/2018/09/laptop-cat2-300x300.jpg"
                                  className="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                  alt=""
                                  loading="lazy"
                                  srcSet="https://ibid.modeltheme.com/wp-content/uploads/2018/09/laptop-cat2-300x300.jpg 300w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/laptop-cat2-200x200.jpg 200w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/laptop-cat2-600x600.jpg 600w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/laptop-cat2-150x150.jpg 150w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/laptop-cat2-768x768.jpg 768w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/laptop-cat2-1024x1024.jpg 1024w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/laptop-cat2-350x350.jpg 350w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/laptop-cat2-110x110.jpg 110w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/laptop-cat2-400x400.jpg 400w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/laptop-cat2-70x70.jpg 70w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/laptop-cat2.jpg 1080w"
                                  sizes="(max-width: 300px) 100vw, 300px"
                                />
                                <img
                                  className="woo_secondary_media_image"
                                ...
                                <div
                                  className="countdownv2_holder "
                                  data-insert-date-start=""
                                  data-insert-date="2022-12-07 00:00:00"
                                  data-unique-id="countdown_636ba5f391c1f"
                                  data-countdown-direction="false"
                                  data-date-format-redux="DHMS"
                                  data-gmt-offset={0}
                                >
                            ...
                            >
                              <h3 className="archive-product-title">
                                <a href="https://ibid.modeltheme.com/product/apple-magic-mouse-2/">
                                  Magic Mouse v2{" "}
                                </a>
                              </h3>
                              <div className="details-container">
