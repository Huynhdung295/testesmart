          ...
          <div className="wpb_wrapper">
            ...
            <div className="woocommerce columns-4 ">
              <ul className="products columns-4">
                        ...
                        <div className="details-price-container details-item">
                          <div className="woocommerce-product-details__short-description">
                            <p>
                              ...
                              2018. The phone comes with a 5.80-inch touchscreen
                              display with a resolution of 1440 pixels by 2960
                              pixels at a PPI of 568 pixels per inch. Samsung
                              Galaxy S9 price in India starts from Rs. 51,990.
                            </p>
                            <p>
                              The Samsung Galaxy S9 runs Android 8.0 and is
                              powered by a 3000mAh non removable battery. It
                              measures 147.70 x 68.70 x 8.50 (height x width x
                              thickness) and weighs 163.00 grams.
                            </p>
                          </div>
                ...
                <li className=" post-4452 product type-product status-publish has-post-thumbnail product_cat-electronics product_cat-televisions product_tag-black-friday product_tag-sales instock sold-individually shipping-taxable product-type-auction">
                  <div className="products-wrapper">
                    <div className="thumbnail-and-details">
                      <div className="overlay-container">
                        <div className="thumbnail-overlay" />
                      ...
                      >
                        ...
                        <div
                          ...
                          data-unique-id="countdown_636b347c19bbe"
                          data-countdown-direction="false"
                          data-date-format-redux="DHMS"
                          data-gmt-offset={0}
                        >
                          <div className="countdownv2_inner_holder">
                            ...
                            <div
                              className="countdownv2 clock is-countdown"
                              id="countdown_636b347c19bbe"
                            >
                              <span className="countdown-row countdown-show4">
                                <span className="countdown-section">
                                  <span className="countdown-amount">22</span>
                                  <span className="countdown-period">Days</span>
                                </span>
                                <span className="countdown-section">
                                  <span className="countdown-amount">9</span>
                    ...
                    >
                      ...
                      <div className="details-container">
                        <div className="details-price-container details-item">
                          <div className="woocommerce-product-details__short-description">
                            <p>
                              Product a reality sandwich before you walk back in
                              that boardroom fire up your browser, so come up
                              with something buzzworthy, for it’s about managing
                ...
                <li className=" post-4450 product type-product status-publish has-post-thumbnail product_cat-electronics product_cat-televisions product_tag-black-friday product_tag-sales last instock sold-individually shipping-taxable product-type-auction">
                  <div className="products-wrapper">
                    <div className="thumbnail-and-details">
                      <div className="overlay-container">
                        <div className="thumbnail-overlay" />
                        <div className="overlay-components">
                          <div className="component add-to-cart">
                            <a
                              href="https://ibid.modeltheme.com/product/smartphone-earbuds/"
                              data-quantity={1}
                              data-tooltip="Bid Now"
                              className="button product_type_auction"
                              data-product_id={4450}
                              data-product_sku="BF015"
                              aria-label="Read more about “Smartphone Earbuds”"
                              rel="nofollow"
                            >
                              <i className="fa fa-gavel" />
                            </a>
                          ...
                          <div className="component wishlist hide-on-mobile">
                            <div className="yith-wcwl-add-to-wishlist add-to-wishlist-4450">
                              <div
                                className="yith-wcwl-add-button show"
                                style={{ display: "block" }}
                              >
                      ...
                      <a
                        className="woo_catalog_media_images"
                        title="Smartphone Earbuds"
                        href="https://ibid.modeltheme.com/product/smartphone-earbuds/"
                      >
                        <img
                          width={300}
                          height={300}
                          src="https://ibid.modeltheme.com/wp-content/uploads/revslider/product-showcase/object_headphones_1-1-300x300.png"
                          className="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                          alt="object_headphones_1"
                          loading="lazy"
                          srcSet="https://ibid.modeltheme.com/wp-content/uploads/revslider/product-showcase/object_headphones_1-1-300x300.png 300w, https://ibid.modeltheme.com/wp-content/uploads/revslider/product-showcase/object_headphones_1-1-200x200.png 200w, https://ibid.modeltheme.com/wp-content/uploads/revslider/product-showcase/object_headphones_1-1-150x150.png 150w, https://ibid.modeltheme.com/wp-content/uploads/revslider/product-showcase/object_headphones_1-1-768x768.png 768w, https://ibid.modeltheme.com/wp-content/uploads/revslider/product-showcase/object_headphones_1-1-1024x1024.png 1024w, https://ibid.modeltheme.com/wp-content/uploads/revslider/product-showcase/object_headphones_1-1-350x350.png 350w, https://ibid.modeltheme.com/wp-content/uploads/revslider/product-showcase/object_headphones_1-1-110x110.png 110w, https://ibid.modeltheme.com/wp-content/uploads/revslider/product-showcase/object_headphones_1-1-400x400.png 400w, https://ibid.modeltheme.com/wp-content/uploads/revslider/product-showcase/object_headphones_1-1-70x70.png 70w, https://ibid.modeltheme.com/wp-content/uploads/revslider/product-showcase/object_headphones_1-1-600x600.png 600w, https://ibid.modeltheme.com/wp-content/uploads/revslider/product-showcase/object_headphones_1-1.png 1600w"
                          sizes="(max-width: 300px) 100vw, 300px"
                        />
                        <img
                          className="woo_secondary_media_image"
                          src="https://ibid.modeltheme.com/wp-content/uploads/2018/09/phone-cat2-400x400.jpg"
                          alt="Smartphone Earbuds"
                        />
                        <div
                          className="countdownv2_holder "
                          data-insert-date-start=""
                          data-insert-date="2022-12-02 00:00:00"
                          data-unique-id="countdown_636b347c1b5bf"
                          data-countdown-direction="false"
                          data-date-format-redux="DHMS"
                          data-gmt-offset={0}
                        >
                    ...
                    >
                      <h3 className="archive-product-title">
                        <a href="https://ibid.modeltheme.com/product/smartphone-earbuds/">
                          Smartphone Earbuds{" "}
                        </a>
                      </h3>
                      <div className="details-container">
                        <div className="details-price-container details-item">
                          <div className="woocommerce-product-details__short-description">
                            <p>
                              ...
                              back in that boardroom fire up your browser, so
                              come up with something buzzworthy, for it’s about
                ...
                <li className=" last post-4451 product type-product status-publish has-post-thumbnail product_cat-electronics product_cat-televisions product_tag-black-friday product_tag-sales first outofstock sold-individually shipping-taxable product-type-auction">
                  <div className="products-wrapper">
                    <div className="thumbnail-and-details">
                      <div className="overlay-container">
                        <div className="thumbnail-overlay" />
                        <div className="overlay-components">
                          <div className="component add-to-cart">
                            <a
                              href="https://ibid.modeltheme.com/product/smart-tv-4k-ultra-hd/"
                              data-quantity={1}
                              data-tooltip="View Auction"
                              className="button product_type_auction"
                              data-product_id={4451}
                              data-product_sku="BF2200"
                              aria-label="Read more about “Smart TV 4K Ultra HD”"
                              rel="nofollow"
                            >
                          ...
                          <div className="component wishlist hide-on-mobile">
                            <div className="yith-wcwl-add-to-wishlist add-to-wishlist-4451">
                              <div
                                className="yith-wcwl-add-button show"
                                style={{ display: "block" }}
                              >
                                <a
                                  href="/?add_to_wishlist=4451"
                      ...
                      >
                        <img
                          width={300}
                          height={300}
                          src="https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat3-300x300.jpg"
                          className="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                          alt=""
                          loading="lazy"
                          srcSet="https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat3-300x300.jpg 300w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat3-200x200.jpg 200w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat3-600x600.jpg 600w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat3-150x150.jpg 150w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat3-768x768.jpg 768w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat3-1024x1024.jpg 1024w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat3-350x350.jpg 350w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat3-110x110.jpg 110w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat3-400x400.jpg 400w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat3-70x70.jpg 70w, https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat3.jpg 1080w"
                          sizes="(max-width: 300px) 100vw, 300px"
                        />
                        <img
                          className="woo_secondary_media_image"
                          src="https://ibid.modeltheme.com/wp-content/uploads/2018/09/electronic-cat2-400x400.jpg"
                          alt="Smart TV 4K Ultra HD"
                        />
                      </a>
                    </div>
                    <span className="auction-bage" />
                    ...
                    >
                      <h3 className="archive-product-title">
                        <a href="https://ibid.modeltheme.com/product/smart-tv-4k-ultra-hd/">
