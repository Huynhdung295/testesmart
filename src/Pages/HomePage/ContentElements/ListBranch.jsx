      ...
      <div className="wpb_column vc_column_container vc_col-sm-12">
        <div className="vc_column-inner">
          <div className="wpb_wrapper">
            ...
            <div
              id="lvca-carousel-636b347c38048"
            ...
            >
              <div aria-live="polite" className="slick-list draggable">
                <div
                  ...
                  style={{ opacity: 1, width: 4028, left: "-1272px" }}
                  role="listbox"
                >
                  <div
                  ...
                  >
                    <img
                      ...
                      src="https://ibid.modeltheme.com/wp-content/uploads/2015/04/client2-s2-2-300x90.png"
                      alt=""
                      width={300}
                      height={90}
                    />
            ...
            <style
              ...
              dangerouslySetInnerHTML={{
                __html:
                  "\n            #lvca-carousel-636b347c38048.lvca-carousel .lvca-carousel-item {\n                padding: 40px;\n                }\n\n            @media screen and (max-width: 800) {\n                #lvca-carousel-636b347c38048.lvca-carousel .lvca-carousel-item {\n                    padding: 10px;\n                    }\n                }\n\n            @media screen and (max-width: 480) {\n                #lvca-carousel-636b347c38048.lvca-carousel .lvca-carousel-item {\n                    padding: 10px;\n                    }\n                }\n        ",
              }}
            />
          </div>
        </div>
